...
csv_path = "/home/zach/Storage/Projects/COVID-19/dataParse/"

deaths = pd.read_csv(csv_path + 'deaths.csv')
cases = pd.read_csv(csv_path + 'cases.csv')
global_cases = pd.read_csv(csv_path + 'global/global_cases.csv')
global_deaths = pd.read_csv(csv_path + 'global/global_deaths.csv')
